  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full">
        ...
        <section className="w-full flex items-center justify-center text-white px-4 sm:px-6 pt-24 md:pt-0 min-h-[calc(100vh-80px)]">
          <motion.div
          ...
          >
            ...
            <p className="text-gray-200 mt-6 max-w-lg mx-auto text-sm sm:text-base leading-relaxed px-2 sm:px-0">
              I build modern, responsive and interactive web applications
              using React, TailwindCSS and Framer Motion.
            </p>

            {/* Buttons */}
            <div className="mt-8 w-full max-w-md mx-auto flex flex-col sm:flex-row gap-4 px-2 sm:px-0">
              <a
                href="#projects"
                className="w-full sm:w-auto flex-1 bg-yellow-400 text-black px-6 py-3 rounded-lg font-medium hover:bg-yellow-300 transition text-center"
              >
                View Projects
              </a>
              ...
              <a
                href="#contact"
                className="w-full sm:w-auto flex-1 border border-gray-600 px-6 py-3 rounded-lg hover:bg-gray-800 transition text-center"
              >
                Contact Me
              </a>
            </div>
            ...
            <div className="mt-12 overflow-hidden border-t border-gray-800 pt-6">
              <div className="animate-[scroll_20s_linear_infinite] whitespace-nowrap text-gray-400 text-xs sm:text-sm">
                React • JavaScript • TailwindCSS • Framer Motion • GitHub •
                Vercel • Responsive Design • React • JavaScript • TailwindCSS •
                Framer Motion •
              </div>
            </div>
          </motion.div>
